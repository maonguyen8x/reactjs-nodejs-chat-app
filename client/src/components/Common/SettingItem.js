...
const SettingItem = (props) => {
  ...
  const onSubmitHandler = (event) => {
    ...
    axios
      .post("/api/users/update-user", data, config)
      .then((data) => {
        // get current user
  ...
  let deleteUserPopup =
    deleteCurrUser === true ? (
      <Popup clearPopupState={() => clearPopuState()}>
        ...
        <button
          className="delete-user-btn delete-user-btn-mobile"
          onClick={() => deleteUser()}
        >
          Delete account
        </button>
  ...
  const deleteUser = () => {
    axios
      .get("/api/users/" + auth.currUser._id + "/delete")
      .then(() => {
        auth.loggedIn = false;
        auth.currUser = null;
        history.push("/");
  ...
  return (
    <div className="row padding-32 scrollable">
      ...
      <div className="col">
        <div className="row justify-center padding-20 settings-wrap">
          <div className="avatar-border">
            <svg
              ...
              data-prefix="fas"
              data-icon="user"
              className="svg-inline--fa fa-user fa-w-14 absolute-center"
              role="img"
              viewBox="0 0 448 512"
            >
              <path
                fill={avatarColor ? avatarColor : auth.currUser.avatarColor}
        ...
        <div
          className="flex-container justify-center margin-s"
        ...
        >
          <div className="column side-padding-8">
            <input
              ...
              value="#E85AAA"
              defaultChecked={
                auth.currUser.avatarColor === "#E85AAA" ? true : false
              }
              className="radio-btn pink"
              name="color"
            />
            <label htmlFor="PINK" className="radio-label">
              Pink
            </label>
          </div>
          ...
          <div className="column side-padding-8">
            <input
              ...
              value="#5DFFA1"
              defaultChecked={
                auth.currUser.avatarColor === "#5DFFA1" ? true : false
              }
              className="radio-btn green"
              name="color"
            />
            <label htmlFor="GREEN" className="radio-label">
              Green
            </label>
          </div>
          ...
          <div className="column side-padding-8">
            <input
              ...
              value="#6363FF"
              defaultChecked={
                auth.currUser.avatarColor === "#6363FF" ? true : false
              }
          ...
          <div className="column side-padding-8">
            <input
              ...
              value="#000"
              defaultChecked={
                auth.currUser.avatarColor === "#000" ? true : false
              }
